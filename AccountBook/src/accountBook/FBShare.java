...
public class FBShare { 
	...
	public void capture() {
		try {
			...
			// JPEG 저장.
			File file = new File("D:/Files/javaDongBu/AccountBook/firebase-AccountSolution/public/capture/screencapture.jpg");
	...
	File theDir = new File("D:/Files/javaDongBu/AccountBook/firebase-AccountSolution/public/capture");
