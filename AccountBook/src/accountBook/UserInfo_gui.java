...
class UserInfo_gui extends JFrame {
	...
	public void createUserInfo(){
		...
		titleL.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 50));
		...
		ClubInfo.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 20));
		...
		UserIdL.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 17));
		UserIdL.setBounds(166, 12, 51, 33);
		UserInfoP.add(UserIdL);
		
		JLabel UserClubL = new JLabel(ui.Clubresult);
		UserClubL.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 17));
		...
		balanceL.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 17));
		balanceL.setBounds(166, 121, 51, 33);
		UserInfoP.add(balanceL);
		
		JLabel lblBalance = new JLabel("Balance");
		lblBalance.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 20));
		lblBalance.setBounds(42, 127, 75, 18);
		UserInfoP.add(lblBalance);
		
		JLabel label = new JLabel("\uC778\uC6D0 :");
		label.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 15));
		...
		changeIdBtn.setFont(new Font("³ª´®°íµñÄÚµù", Font.PLAIN, 17));
